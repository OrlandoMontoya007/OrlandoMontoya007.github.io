...
// define an object using a constructure function
function Employee(name, title, phone)
{
    ...
    this.title = title;
    this.phone = phone;
    //assign method the the employee object
    this.printEmployee = printEmployee;
}

//create employe objects
var nick = new Employee("Nick", "Instructor", "(956) 872-3445" );
var lisa = new Employee("Lisa Simpson", "Teacher", "(956) 453-4531" );
var mike = new Employee("Mike Tyson", "Boxer", "(956) 741-6575" );
...
//crate an arry of employie names
var empArray = [nick.name, lisa.name, mike.name];

empArray = empArray.sort(); //built in sor function sorts letters not number
